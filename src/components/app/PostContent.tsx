...
export default function PostContent() {
  return (
    <div
      className="mt-5
     p-5 gap-[10px] md:w-full xl:w-[798px] h-auto rounded-[12px] bg-white border"
    >
      ...
      <div>
        <button className="w-auto h-auto rounded-[16px] mt-3 px-2 py-1 bg-[#F3F3F3]">
          <p className="text-[16px] text-[#4A4A4A]">History</p>
        </button>
      </div>
      <div className="mt-1">
      ...
      <div className="flex mt-1 items-center gap-1">
        ...
        <p className="text-[#939494] text-[12px]"> 32 comment</p>
      </div>
    </div>
  );
}
